...
class MainViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        NSNotificationCenter.defaultCenter().dropObserver(willEnterForegroundObserver)
        ...
        NSNotificationCenter.defaultCenter().dropObserver(signInObserver)
 
        signInObserver = NSNotificationCenter.defaultCenter().addObserverForName(AWSIdentityManagerDidSignInNotification, object: AWSIdentityManager.defaultIdentityManager(), queue: NSOperationQueue.mainQueue(), usingBlock:
            {[weak self] (note: NSNotification) -> Void in
                guard let strongSelf = self else { return }
                NSLog("Sign In Observer observed sign in.")
        ...
        NSNotificationCenter.defaultCenter().dropObserver(signOutObserver)
...
extension NSNotificationCenter {
    func dropObserver(observer:AnyObject?) {
        if observer != nil {
