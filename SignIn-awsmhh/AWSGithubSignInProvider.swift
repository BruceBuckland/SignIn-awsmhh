//
//  AWSGithubSignInProvider.swift
//  Use Github to provide OAuth 2.0 authentication tokens and feed those to 
//  Amazon's AWSIdentityManager by using Google GTM-OAuth2 library to create
//  an OAuth 2 compatible AWSSignInProvider.
//  Should be able to act as a model for other AWSSignInProvider implementations
//  Because GTM OAuth2 supports OAUTH2 providers in general.
//
//  Created by Bruce Buckland on 10/29/16.
...
@objc(AWSGithubIdPSignInProvider)


class AWSGithubIdPSignInProvider: NSObject, AWSSignInProvider {
